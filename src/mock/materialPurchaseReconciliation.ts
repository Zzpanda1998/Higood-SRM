...
const seeds: Seed[] = [
  ...
  { no: "ID-MP-2026-0003", goodsNo: "GP-2026-0002", supplier: "东莞宏远辅料有限公司", sku: "ACC-2026-0003", name: "YKK 5号尼龙拉链", spec: "黑色 / 60cm", unit: "条", type: "辅料", purchaser: "李采购", status: "部分确认", ordered: "2026-06-02", arrived: "2026-06-08", inbound: "2026-06-09", purchaseQty: 6200, arrivedQty: 6150, inboundQty: 6100, currency: "RMB", price: 1.25, bill: 7600, adjustment: -25, differenceReason: "供应商按实收数量结算", adjustmentReason: "扣除破损件", confirmed: ["采购货款"] },
  { no: "ID-MP-2026-0004", goodsNo: "GP-2026-0002", supplier: "苏州恒润包装材料有限公司", sku: "PKG-2026-0004", name: "五层出口纸箱", spec: "60×40×30", unit: "箱", type: "包材", purchaser: "陈采购", status: "已确认", ordered: "2026-06-03", arrived: "2026-06-08", inbound: "2026-06-09", purchaseQty: 1200, arrivedQty: 1200, inboundQty: 1200, currency: "RMB", price: 2.6, bill: 3120, confirmed: ["采购货款", "调整金额"], remark: "出口包装" },
  ...
  { no: "ID-MP-2026-0007", goodsNo: "GP-2026-0005", supplier: "泉州瑞达服装辅料有限公司", sku: "ACC-2026-0007", name: "黑色四眼纽扣", spec: "黑色 / 18mm", unit: "个", type: "辅料", purchaser: "李采购", status: "已确认", ordered: "2026-06-04", arrived: "2026-06-09", inbound: "2026-06-10", purchaseQty: 7600, arrivedQty: 7600, inboundQty: 7600, currency: "RMB", price: 0.08, bill: 608, confirmed: ["采购货款", "调整金额"] },
  { no: "ID-MP-2026-0008", goodsNo: "GP-2026-0006", supplier: "深圳优品包材有限公司", sku: "PKG-2026-0008", name: "40×60cm透明胶袋", spec: "透明 / 8丝", unit: "个", type: "包材", purchaser: "陈采购", status: "待确认", ordered: "2026-06-05", purchaseQty: 2100, arrivedQty: 0, inboundQty: 0, currency: "RMB", price: 0.35 },
