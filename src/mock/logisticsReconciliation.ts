...
export const logisticsFeeItems: LogisticsFeeItem[] = ["运费", "国内物流费", "头程物流费", "关税", "增值税", "清关费", "附加费", "报关费"];

export const calculateLogisticsTotal = (fee: Omit<LogisticsFeeDetail, "totalFee" | "feeType"> | LogisticsFeeDetail) =>
  (fee.freightFee ?? 0) +
  (fee.domesticLogisticsFee ?? 0) +
...
const seeds: Array<Omit<LogisticsReconciliationRow, "id" | "firstLegNo" | "differenceAmount" | "confirmedItems"> & { confirmed?: LogisticsFeeItem[] }> = [
  { logisticsNo: "LOG-202606-0001", forwarderName: "DHL Global Forwarding", waybillNo: "DHL-CN-882011", shipmentId: "SHP-ID-260601", channel: "东南亚专线", forwarderChannelName: "DHL Express Worldwide", destination: "雅加达仓", status: "待确认", transportMethod: "空运", shippedAt: "2026-06-01", expectedSignedAt: "2026-06-06", actualSignedAt: "2026-06-06", signedQty: 1280, remark: "面辅料空运", estimatedFee: fee("预计", { freightFee: 1581, domesticLogisticsFee: 260, firstLegLogisticsFee: 1581, customsDutyFee: 420, vatFee: 210, clearanceFee: 180 }), actualFee: fee("实际", { freightFee: 1660, domesticLogisticsFee: 260, firstLegLogisticsFee: 1581, customsDutyFee: 460, vatFee: 210, clearanceFee: 180, additionalFee: 95 }), confirmStatus: "未确认" },
  { logisticsNo: "LOG-202606-0002", forwarderName: "Maersk Logistics", waybillNo: "MSK-992001", shipmentId: "SHP-ID-260602", channel: "海运拼箱", forwarderChannelName: "Maersk LCL", destination: "泗水仓", status: "部分确认", transportMethod: "海运", shippedAt: "2026-05-24", expectedSignedAt: "2026-06-15", signedQty: 3500, remark: "整柜拼箱", estimatedFee: fee("预计", { freightFee: 944, domesticLogisticsFee: 315, firstLegLogisticsFee: 3200, customsDutyFee: 820, vatFee: 410, clearanceFee: 260, customsDeclarationFee: 180 }), actualFee: fee("实际", { freightFee: 944, domesticLogisticsFee: 300, firstLegLogisticsFee: 3100, customsDutyFee: 800, vatFee: 410, clearanceFee: 260, customsDeclarationFee: 180 }), confirmStatus: "部分确认", confirmed: ["运费", "国内物流费", "头程物流费"] },
  { logisticsNo: "LOG-202606-0003", forwarderName: "顺丰速运", waybillNo: "SF1688200331", channel: "国内快递", forwarderChannelName: "顺丰标快", destination: "广州中转仓", status: "待确认", transportMethod: "快递", shippedAt: "2026-06-03", expectedSignedAt: "2026-06-05", actualSignedAt: "2026-06-05", signedQty: 420, estimatedFee: fee("预计", { freightFee: 315, domesticLogisticsFee: 315 }), confirmStatus: "未确认" },
  { logisticsNo: "LOG-202606-0004", forwarderName: "广州海航国际货运", waybillNo: "HHA-260604", shipmentId: "SHP-ID-260604", channel: "印尼空运", forwarderChannelName: "空运普货", destination: "万隆仓", status: "已确认", transportMethod: "空运", shippedAt: "2026-05-30", expectedSignedAt: "2026-06-05", actualSignedAt: "2026-06-05", signedQty: 980, estimatedFee: fee("预计", { freightFee: 1260, firstLegLogisticsFee: 1260, customsDutyFee: 360, vatFee: 180, clearanceFee: 160 }), actualFee: fee("实际", { freightFee: 1260, firstLegLogisticsFee: 1260, customsDutyFee: 360, vatFee: 180, clearanceFee: 160 }), confirmStatus: "已确认", confirmed: logisticsFeeItems, confirmedBy: "王采购", confirmedAt: "2026-06-06 10:20" },
  { logisticsNo: "LOG-202606-0005", forwarderName: "德邦物流", waybillNo: "DB926060501", channel: "国内零担", forwarderChannelName: "精准卡航", destination: "深圳头程仓", status: "待确认", transportMethod: "陆运", shippedAt: "2026-06-05", expectedSignedAt: "2026-06-08", actualSignedAt: "2026-06-08", signedQty: 720, estimatedFee: fee("预计", { domesticLogisticsFee: 680, additionalFee: 50 }), actualFee: fee("实际", { domesticLogisticsFee: 620, additionalFee: 35 }), confirmStatus: "未确认" },
  ...
  { logisticsNo: "LOG-202606-0007", forwarderName: "跨越速运", waybillNo: "KY260607001", channel: "国内快运", forwarderChannelName: "当天达", destination: "广州中转仓", status: "已确认", transportMethod: "快递", shippedAt: "2026-06-07", expectedSignedAt: "2026-06-07", actualSignedAt: "2026-06-07", signedQty: 180, estimatedFee: fee("预计", { domesticLogisticsFee: 420 }), actualFee: fee("实际", { domesticLogisticsFee: 420 }), confirmStatus: "已确认", confirmed: logisticsFeeItems, confirmedBy: "李采购", confirmedAt: "2026-06-08 09:10" },
  { logisticsNo: "LOG-202606-0008", forwarderName: "深圳远洋货代", waybillNo: "SYO-260608", shipmentId: "SHP-ID-260608", channel: "海运整柜", forwarderChannelName: "FCL 40HQ", destination: "泗水仓", status: "待确认", transportMethod: "海运", shippedAt: "2026-05-18", expectedSignedAt: "2026-06-18", signedQty: 8200, estimatedFee: fee("预计", { freightFee: 5300, firstLegLogisticsFee: 5300, customsDutyFee: 1250, vatFee: 625, clearanceFee: 380, additionalFee: 260, customsDeclarationFee: 220 }), confirmStatus: "未确认" },
  { logisticsNo: "LOG-202606-0009", forwarderName: "京东物流", waybillNo: "JDVA26060901", channel: "国内快递", forwarderChannelName: "特惠送", destination: "义乌中转仓", status: "部分确认", transportMethod: "快递", shippedAt: "2026-06-08", expectedSignedAt: "2026-06-10", actualSignedAt: "2026-06-10", signedQty: 260, estimatedFee: fee("预计", { freightFee: 280, domesticLogisticsFee: 280, additionalFee: 25 }), actualFee: fee("实际", { freightFee: 300, domesticLogisticsFee: 280, additionalFee: 25 }), confirmStatus: "部分确认", confirmed: ["国内物流费", "附加费"] },
  { logisticsNo: "LOG-202606-0010", forwarderName: "FedEx", waybillNo: "FDX-260610", shipmentId: "SHP-ID-260610", channel: "国际快递", forwarderChannelName: "FedEx International Priority", destination: "巴厘岛仓", status: "待确认", transportMethod: "空运", shippedAt: "2026-06-09", expectedSignedAt: "2026-06-13", signedQty: 350, estimatedFee: fee("预计", { freightFee: 2100, firstLegLogisticsFee: 2100, customsDutyFee: 520, vatFee: 260, clearanceFee: 190, additionalFee: 85, customsDeclarationFee: 150 }), actualFee: fee("实际", { freightFee: 2020, firstLegLogisticsFee: 2050, customsDutyFee: 500, vatFee: 260, clearanceFee: 190, additionalFee: 70, customsDeclarationFee: 150 }), confirmStatus: "未确认" },
];
